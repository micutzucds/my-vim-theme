...
hi Directory       guifg=LightBlue guibg=bg
...
hi MatchParen      guifg=#000000 guibg=LightBlue gui=NONE
...
if s:molokai_original == 1
   ...
   hi CursorLine                    guibg=#3B3A32
   hi CursorColumn                  guibg=#3B3A32
